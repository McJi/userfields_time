<?php
define('C_REST_CLIENT_ID','app.61011900098690.34863631');//Application ID
define('C_REST_CLIENT_SECRET','ll3f3ubmO3GR0uqU6eEVTMewwUSJlHqeP5rytr5VwI3l6VwABF');//Application key
// or
